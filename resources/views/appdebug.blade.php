                    ...
                    <form class="form-horizontal" role="form" action="" method="post">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" id="userid" name="userid"
                                placeholder="USER_ID、AUTH_ID只填一个用于加密解密，USER_ID对应多条AUTH_ID时自动选择最后添加的一条，两个都为空则不加密" autocomplete="on">
                            </div>
                        </div>
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" id="authid" name="authid"
                                placeholder="USER_ID、AUTH_ID只填一个用于加密解密，两个都为空则不加密" autocomplete="on">
                            </div>
                        </div>
                        <div class="form-group">
        ...
        <script type="text/javascript">
            function apitest() {
                ...
                $.ajax({
                    ...
                    data:"server="+server+"&apiurl="+apiurl+"&type="+type+"&userid="+userid+"&authid="+authid+"&data="+data,
